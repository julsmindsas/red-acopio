...
/*
 * Sección Open Source + postura de datos (Server Component).
 * Dos tarjetas:
 *   1. Proyecto libre (MIT) con CTAs a GitHub: contribuir / reportar.
 *   2. Compromiso de trazabilidad: cada punto cita su fuente pública.
 */
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-4 py-12 sm:py-16">
      <div className="grid gap-5 md:grid-cols-2">
        ...
        {/* Postura de datos: la promesa que sostiene la herramienta */}
        <div className="flex flex-col rounded-3xl border border-brand-200 bg-brand-50/60 p-7 shadow-sm sm:p-8">
          <span aria-hidden="true" className="text-3xl">
            🛡️
          </span>
          <h2 className="mt-4 text-xl font-bold tracking-tight text-foreground sm:text-2xl">
            Cada punto dice de dónde salió
          </h2>
          <p className="mt-3 flex-1 text-sm leading-relaxed text-foreground/70 sm:text-base">
            Aquí no se inventan puntos. Cada uno lleva su{" "}
            <strong className="font-semibold text-foreground">
              enlace a la fuente pública
            </strong>{" "}
            y su estado de verificación, y avisa cuando su ubicación es
            aproximada. Una dirección equivocada, en una emergencia, manda a
            alguien al lugar equivocado.
          </p>
          <Link
            href="/ayuda"
